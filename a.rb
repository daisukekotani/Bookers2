...
ユーザー権限のテスト
  ログインしていない場合
    投稿関連のURLにアクセス
[31m      一覧画面に遷移できない (FAILED - 7)[0m
[31m      編集画面に遷移できない (FAILED - 8)[0m
[31m      詳細画面に遷移できない (FAILED - 9)[0m
  ログインしていない場合にユーザー関連のURLにアクセス
    ユーザー関連のURLにアクセス
[31m      一覧画面に遷移できない (FAILED - 10)[0m
[31m      編集画面に遷移できない (FAILED - 11)[0m
[31m      詳細画面に遷移でない (FAILED - 12)[0m
...
[32m      編集に失敗する[0m
  一覧画面のテスト
    表示の確認
[32m      Usersと表示される[0m
[31m      自分と他の人の画像が表示される (FAILED - 15)[0m
...
Failures:
  ...
  2) 投稿のテスト 編集のテスト 表示の確認 title編集フォームが表示される
     ...
     [31m  expected to find visible field "book[title]" that is not disabled with value "0raey" but there were no matches. Also found "", which matched the selector but not all filters. Expected value to be "0raey" but was nil[0m
     [31m[0m
     [31m[0m
     [31m[0m
  ...
  3) 投稿のテスト 編集のテスト 表示の確認 opinion編集フォームが表示される
     ...
     [31m  expected to find visible field "book[body]" that is not disabled with value "p97ys47wsaylknebw1us" but there were no matches. Also found "", which matched the selector but not all filters. Expected value to be "p97ys47wsaylknebw1us" but was nil[0m
     [31m[0m
     [31m[0m
     [31m[0m
  ...
  6) 投稿のテスト 詳細画面のテスト 自分・他人共通の投稿詳細画面の表示を確認 ユーザー画像・名前のリンク先が正しい
     ...
     [31m  expected to find link "zaw61xcoln" with href "/users/2" but there were no matches[0m
     [31m[0m
     [31m[0m
     [31m[0m
     [36m# ./spec/system/books_spec.rb:123:in `block (4 levels) in <main>'[0m

  7) ユーザー権限のテスト ログインしていない場合 投稿関連のURLにアクセス 一覧画面に遷移できない
     ...
     [31m[0m
     [31m[0m
     [36m# ./app/views/books/index.html.erb:27:in `_app_views_books_index_html_erb___187950171435325786_55325880'[0m
  ...
  8) ユーザー権限のテスト ログインしていない場合 投稿関連のURLにアクセス 編集画面に遷移できない
  ...
  9) ユーザー権限のテスト ログインしていない場合 投稿関連のURLにアクセス 詳細画面に遷移できない
     [31mFailure/Error: [0m<th><[31m[1;31m%=[0m[31m current_user.name %></th>[0m[0m
     [31m[0m
     [31mActionView::Template::Error:[0m
     [31m  undefined method `name' for nil:NilClass[0m
     ...
     [31m[0m
     [31m[0m
     [36m# ./app/views/books/show.html.erb:14:in `_app_views_books_show_html_erb___3095070457377660313_72100720'[0m
     [36m# /home/ec2-user/.rvm/gems/ruby-2.6.3/gems/warden-1.2.9/lib/warden/manager.rb:36:in `block in call'[0m
     [36m# /home/ec2-user/.rvm/gems/ruby-2.6.3/gems/warden-1.2.9/lib/warden/manager.rb:34:in `catch'[0m
     [36m# /home/ec2-user/.rvm/gems/ruby-2.6.3/gems/warden-1.2.9/lib/warden/manager.rb:34:in `call'[0m
     [36m# /home/ec2-user/.rvm/gems/ruby-2.6.3/gems/rack-2.2.3/lib/rack/tempfile_reaper.rb:15:in `call'[0m
  ...
  10) ユーザー権限のテスト ログインしていない場合にユーザー関連のURLにアクセス ユーザー関連のURLにアクセス 一覧画面に遷移できない
      [31mFailure/Error: [0m<th><[31m[1;31m%=[0m[31m current_user.name %></th>[0m[0m
      [31m[0m
      [31mActionView::Template::Error:[0m
      [31m  undefined method `name' for nil:NilClass[0m
      ...
      [31m[0m
      [31m[0m
      [36m# ./app/views/users/index.html.erb:14:in `_app_views_users_index_html_erb__1657789474424945248_75324620'[0m
      [36m# /home/ec2-user/.rvm/gems/ruby-2.6.3/gems/warden-1.2.9/lib/warden/manager.rb:36:in `block in call'[0m
      [36m# /home/ec2-user/.rvm/gems/ruby-2.6.3/gems/warden-1.2.9/lib/warden/manager.rb:34:in `catch'[0m
      [36m# /home/ec2-user/.rvm/gems/ruby-2.6.3/gems/warden-1.2.9/lib/warden/manager.rb:34:in `call'[0m
      [36m# /home/ec2-user/.rvm/gems/ruby-2.6.3/gems/rack-2.2.3/lib/rack/tempfile_reaper.rb:15:in `call'[0m
  ...
  11) ユーザー権限のテスト ログインしていない場合にユーザー関連のURLにアクセス ユーザー関連のURLにアクセス 編集画面に遷移できない
      [31mFailure/Error: [0m[32mexpect[0m(current_path).to eq([31m[1;31m'[0m[31m/users/sign_in[1;31m'[0m[31m[0m)[0m
      [31m[0m
      [31m  expected: "/users/sign_in"[0m
  ...
  12) ユーザー権限のテスト ログインしていない場合にユーザー関連のURLにアクセス ユーザー関連のURLにアクセス 詳細画面に遷移でない
      ...
      [31m[0m
      [31m[0m
      [36m# ./app/views/users/show.html.erb:7:in `_app_views_users_show_html_erb__603157456208920293_58947740'[0m
      [36m# /home/ec2-user/.rvm/gems/ruby-2.6.3/gems/warden-1.2.9/lib/warden/manager.rb:36:in `block in call'[0m
      [36m# /home/ec2-user/.rvm/gems/ruby-2.6.3/gems/warden-1.2.9/lib/warden/manager.rb:34:in `catch'[0m
      [36m# /home/ec2-user/.rvm/gems/ruby-2.6.3/gems/warden-1.2.9/lib/warden/manager.rb:34:in `call'[0m
      [36m# /home/ec2-user/.rvm/gems/ruby-2.6.3/gems/rack-2.2.3/lib/rack/tempfile_reaper.rb:15:in `call'[0m
  ...
  13) ユーザーのテスト サイドバーのテスト 表示の確認 画像が表示される
  ...
  14) ユーザーのテスト 編集のテスト 他人の編集画面への遷移 遷移できない
  ...
  15) ユーザーのテスト 一覧画面のテスト 表示の確認 自分と他の人の画像が表示される
...
Finished in 3.61 seconds (files took 3 seconds to load)
[31m95 examples, 15 failures[0m
